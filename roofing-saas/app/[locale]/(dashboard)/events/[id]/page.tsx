      ...
      <div className="p-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-8 text-center">
            ...
            <p className="text-red-300 mb-4">The event you are trying to view does not exist.</p>
        ...
        <div className="bg-card shadow-sm rounded-lg border border p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusBadge(event.status ?? 'scheduled')}`}>
