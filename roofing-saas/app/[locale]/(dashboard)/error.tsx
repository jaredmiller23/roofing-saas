 ...
 *
 * Catches errors within the dashboard section and provides a user-friendly error page.
 * Automatically reports errors to Sentry for tracking and debugging.
 * Preserves the dashboard layout context.
 */
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-muted p-3 rounded-md">
            <p className="text-sm text-muted-foreground">
              <strong>What happened?</strong> An unexpected error occurred while loading this section of the dashboard.
            </p>
