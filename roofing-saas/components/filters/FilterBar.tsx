        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative group">
            ...
            {configs.filter(c => c.is_quick_filter).length > 0 && (
              <div className="absolute left-0 top-full mt-1 w-56 bg-card rounded-lg shadow-lg border border-border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10">
                <div className="p-2">
