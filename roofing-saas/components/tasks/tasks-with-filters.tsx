...
/**
 * Client component that integrates configurable filters with tasks list
 * Coordinates FilterBar and TasksList
 */
export function TasksWithFilters() {
  const searchParams = useSearchParams()

  // Create a stable string representation of search params
  const searchParamsString = searchParams.toString()

  // Convert search params to object for TasksList (memoized to prevent infinite loops)
  ...
  const handleFiltersChange = useCallback(
    (filters: ActiveFilter[]) => {
      ...
      window.history.pushState(null, '', `/tasks?${currentParams.toString()}`)
    },
