...
/**
 * Client component that integrates configurable filters with projects table
...
export function ProjectsWithFilters() {
  ...
  // Convert search params to object for ProjectsTable (memoized to prevent infinite loops)
