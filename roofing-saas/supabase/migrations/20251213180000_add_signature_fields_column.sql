-- Migration: Add signature_fields JSONB column to signature_documents
-- Rollback: ALTER TABLE signature_documents DROP COLUMN IF EXISTS signature_fields;

-- Add signature_fields column to store field placements for signing
